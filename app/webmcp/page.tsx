...
export default function WebMcpProofPage() {
  return <main className="webmcp-proof-page" id="main-content" tabIndex={-1}>
    <header className="proof-header">
      ...
      <p className="lead">TrialBridge TW combines one declarative form tool with six imperative tools. The human interface remains complete when WebMCP is unavailable, while compatible browser agents receive typed, origin-scoped, read-only capabilities.</p>
      <div className="proof-summary" aria-label="WebMCP implementation summary"><span><strong>1</strong> declarative tool</span><span><strong>6</strong> imperative tools</span><span><strong>10</strong> journey eval cases</span><span><strong>0</strong> send or enrollment tools</span></div>
    </header>
    ...
    <section className="proof-section proof-guardrails" aria-labelledby="guardrails-title">
      ...
      <div className="method-proof-grid"><article><strong>Data minimized</strong><p>Raw and masked notes never enter a WebMCP schema or result.</p></article><article><strong>State-aware recovery</strong><p>Pending-question calls return a safe next step without recording an answer.</p></article><article><strong>No consequential writes</strong><p>No tool can enroll, send, book, consent, or change treatment.</p></article></div>
    </section>
