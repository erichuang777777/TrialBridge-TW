...
export function LandingTrialSearch() {
  ...
  return (
    <section className="database-shell landing-tool" aria-labelledby="landing-search-title">
      <form id="landing-public-trial-search-form" action="/api/trials/search" method="post" toolname={publicTrialFormContractCore.name} tooldescription={publicTrialFormContractCore.description} toolautosubmit="" onSubmit={submit}>
