export type WebMcpJourneyState = "public" | "confirmed_with_questions" | "results_ready";
...
export const webMcpJourneyCases: WebMcpJourneyCase[] = [
  ...
  { id: "followups-direct-en", prompt: "What information do I still need to answer before you show the comparison?", language: "en", state: "confirmed_with_questions", intent: "direct", expectedTools: ["review_trial_followups"], expectedBoundary: "List questions only; answers stay in the visible form." },
  { id: "followups-recovery-zh", prompt: "為什麼還沒有結果？下一步要回答什麼？", language: "zh-Hant", state: "confirmed_with_questions", intent: "recovery", expectedTools: ["review_trial_followups"], expectedBoundary: "Return a context-aware next step without recording data." },
  ...
  { id: "brief-ambiguous-zh", prompt: "我想把這些結果帶去跟醫師談，幫我整理。", language: "zh-Hant", state: "results_ready", intent: "ambiguous", expectedTools: ["draft_trial_discussion_brief"], expectedBoundary: "Create a local unsent brief." },
  { id: "outreach-direct-en", prompt: "Draft a message asking the study team about this trial.", language: "en", state: "results_ready", intent: "direct", expectedTools: ["draft_trial_outreach"], expectedBoundary: "Draft only; never send." },
