...
2. Registry layer: TFDA and ClinicalTrials.gov adapters, a versioned 19-group bilingual query bridge, normalization, provenance, deduplication, Taiwan-to-Asia-to-world retrieval, ranking, and fixtures.
...
6. WebMCP: public and sensitive tools, dynamic registration, consent gates, untrusted registry output, user-controlled shortlist comparison, inspector and browser verification.
