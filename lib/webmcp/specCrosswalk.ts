...
export const webMcpSpecCrosswalk = [
  ...
  },
  {
    ...
    standardState: "Draft ModelContext.registerTool(), ModelContextTool, and localized title guidance",
    specUrl: `${upstreamDraft}#model-context-container`,
    implementation: "Seven imperative capabilities use stable unique names, bounded JSON Schemas, explicit descriptions, and page-language human titles; none has enrollment or send authority.",
